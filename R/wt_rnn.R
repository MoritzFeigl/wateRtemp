  ...
  for(catchment in catchment){
    ...
    for(data_inputs in data_inputs_meta){
      ...
      if(data_inputs == "simple"){
        relevant_data <- c("date", "wt", "Q", "Tmean")
      }
      if(data_inputs == "precip"){
        relevant_data <- c("date", "wt", "Q", "Tmean", "RR")
      }
      if(data_inputs == "radiation"){
        relevant_data <- c("date", "wt", "Q", "Tmean", "GL")
      }
      if(data_inputs == "all"){
        relevant_data <- c("date", "wt", "Q", "Tmean", "RR", "GL")
      }
